...
<table>
    <tr>
        ...
        <td>
            <img src="Design/MeadowRoverBle.png" alt="iot, dotnet, meadow, rover"/><br/>
        ...
        <td>
            <img src="Design/MeadowWifi.png" alt="iot, dotnet, meadow, wifi"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/MeadowBleLed.png" alt="iot, dotnet, meadow, bluetooth, led"/><br/>
        ...
        <td>
            <img src="Design/MeadowBleServo.png" alt="iot, dotnet, meadow, servo, bluetooth, ble"/><br/>
        ...
        <td>
        <img src="Design/MeadowBleTemperature.png" alt="iot, dotnet, meadow, temperature, bluetooth, ble"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/MeadowMapleLed.png" alt="iot, dotnet, meadow, maple, led"/><br/>
        ...
        <td>
            <img src="Design/MeadowMapleServo.png" alt="iot, dotnet, meadow, maple, servo"/><br/>
        ...
        <td>
        <img src="Design/MeadowMapleTemperature.png" alt="iot, dotnet, meadow, maple, sensor, temperature"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/WifiWeather.png" alt="iot, dotnet, meadow, wifi, weather"/><br/>
        ...
        <td>
            <img src="Design/MeadowClockGraphics.png" alt="iot, dotnet, meadow, st7789, graphics"/><br/>
        ...
        <td>
            <img src="Design/GalleryViewer.png" alt="iot, dotnet, meadow, graphics, st7789"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/WifiWeatherClock.png" alt="iot, dotnet, meadow, graphics, clock"/><br/>
        ...
        <td>
            <img src="Design/WifiClock.png" alt="iot, dotnet, meadow, character, lcd, wifi"/><br/>
        ...
        <td>
            <img src="Design/ServoButton.png" alt="iot, dotnet, meadow, servo, button"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/TemperatureMonitor.png" alt="iot, dotnet, meadow, temperature"/><br/>
        ...
        <td>
            <img src="Design/RotaryLedBar.png" alt="iot, dotnet, meadow, rotary-encoder, led-bar"/><br/>
        ...
        <td>
            <img src="Design/Simon.png" alt="iot, dotnet, meadow, retro, simon, game"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/McpLeds.png" alt="iot, dotnet, meadow, mcp23008, io-expander"/><br/>
        ...
        <td>
            <img src="Design/MerryXmasLights.png" alt="iot, dotnet, meadow, led-strip, xmas, lights"/><br/>
        ...
        <td>
            <img src="Design/ShiftRegisterLeds.png" alt="iot, dotnet, meadow, shift-registers, 74hc595"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/RadioPlayer.png" alt="iot, dotnet, meadow, radio-player, fm, audio"/><br/>
        ...
        <td>
            <img src="Design/RotaryServo.png" alt="iot, dotnet, meadow, rotary-encoder, servo"/><br/>
        ...
        <td>
            <img src="Design/MeadowMenu.png" alt="iot, dotnet, meadow, text-display-menu, menu"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/RoverLed.png" alt="iot, dotnet, meadow, rover, led"/><br/>
        ...
        <td>
            <img src="Design/ObstacleRadar.png" alt="iot, dotnet, meadow, sensors, displays, graphics"/><br/>
        ...
        <td>
            <img src="Design/MeadowClock.png" alt="iot, dotnet, meadow, clock, lcd, buttons"/><br/>
    ...
    <tr>
        <td>
            <img src="Design/TouchKeypad.png" alt="iot, dotnet, meadow, touch-keypad, graphics, display"/><br/>
        ...
        <td>
            <img src="Design/ChristmasCountdown.png" alt="iot, dotnet, meadow, christmas, countdown"/><br/>
        ...
        <td>
            <img src="Design/LedJoystick.png" alt="iot, dotnet, meadow, joystick"/><br/>
